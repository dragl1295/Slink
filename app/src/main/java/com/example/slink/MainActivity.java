...
import com.example.slink.contacts.ContactsActivity;
import com.example.slink.databinding.ActivityMainBinding;
import com.example.slink.menu.CallsFragment;
import com.example.slink.menu.CameraFragment;
import com.example.slink.menu.ChatsFragment;
import com.example.slink.menu.StatusFragment;
import com.example.slink.settings.SettingsActivity;
import com.example.slink.status.AddStatusPicActivity;
            ...
            public void run() {
                switch (index){
                    ...
                    case 2 :
                        ...
                        binding.fabAction.show(); binding.fabAction.setImageDrawable(getDrawable(R.drawable.ic_baseline_photo_camera_24));
