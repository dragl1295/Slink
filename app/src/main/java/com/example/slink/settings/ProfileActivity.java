...
import com.example.slink.databinding.ActivityProfileBinding;
import com.example.slink.startup.SplashScreenActivity;
    ...
    private void getInfo() {
        firestore.collection("Users").document(firebaseUser.getUid()).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                Glide.with(ProfileActivity.this).load(imageProfile).
                        placeholder(R.drawable.avatar).into(binding.imageProfile);
